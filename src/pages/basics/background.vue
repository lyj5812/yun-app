<template>
  <view>
    ...
    <view class="cu-bar bg-white solid-bottom">
      <view class="action">
        <text class="cuIcon-title text-blue" />深色背景
      </view>
    </view>
    ...
    <view class="cu-bar bg-white solid-bottom">
      <view class="action">
        <text class="cuIcon-title text-blue" />淡色背景
      </view>
    </view>
    <view class="grid col-3 bg-white padding-sm">
      <view v-for="(item,index) in ColorList" v-if="index<12" :key="index" class="padding-sm">
