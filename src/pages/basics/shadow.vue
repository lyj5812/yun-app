<template>
  <view>
    <cu-custom bg-color="bg-gradual-blue" :is-back="true"><block slot="backText">返回</block><block slot="content">边框阴影</block></cu-custom>
    <view class="cu-bar bg-white solid-bottom">
      <view class="action">
        <text class="cuIcon-title text-blue" />边框
      </view>
      <view class="action">
        <switch class="sm" :class="size?'checked':''" @change="SetSize" />
      </view>
    </view>
    ...
    <view class="cu-bar bg-white margin-top">
      <view class="action">
        <text class="cuIcon-title text-blue" />阴影
      </view>
    </view>
