<template>
  <view>
    <cu-custom bg-color="bg-gradual-blue" :is-back="true"><block slot="backText">返回</block><block slot="content">标签</block></cu-custom>
    <view class="cu-bar bg-white solid-bottom">
      <view class="action">
        <text class="cuIcon-title text-blue" />标签形状
      </view>
    </view>
    ...
    <view class="padding-sm flex flex-wrap">
      <view v-for="(item,index) in ColorList" v-if="item.name!='gray'" :key="index" class="padding-xs">
        <view class="cu-tag" :class="'bg-' + item.name">{{ item.title }}</view>
      </view>
      <view v-for="(item,index) in ColorList" v-if="item.name!='gray' && item.name!='black' && item.name!='white'" :key="index" class="padding-xs">
    ...
    <view class="padding-sm flex flex-wrap">
      <view v-for="(item,index) in ColorList" v-if="item.name!='white'" :key="index" class="padding-xs">
