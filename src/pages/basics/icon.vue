<template>
  <view>
    <cu-custom bg-color="bg-gradual-blue" :is-back="true"><block slot="backText">返回</block><block slot="content">图标</block></cu-custom>
    ...
    <view class="cu-list grid col-3">
      <view v-for="(item,index) in cuIcon" v-if="item.isShow" :key="index" class="cu-item">
        <text class="lg text-gray" :class="'cuIcon-' + item.name" />
        <text>{{ item.name }}</text>
      </view>
    </view>
  </view>
