<template>
  <view>
    <cu-custom bg-color="bg-gradual-blue" :is-back="true"><block slot="backText">返回</block><block slot="content">文本</block></cu-custom>
    <view class="cu-bar bg-white solid-bottom">
      <view class="action">
        <text class="cuIcon-title text-blue" />文字大小
      </view>
    </view>
    ...
    <view class="cu-bar bg-white solid-bottom margin-top">
      <view class="action">
        <text class="cuIcon-title text-blue" />文字颜色
      </view>
    </view>
    <view class="grid col-5 padding-sm">
      <view v-for="(item,index) in ColorList" :key="index" class="padding-sm">
    ...
    <view class="cu-bar bg-white solid-bottom margin-top">
      <view class="action">
        <text class="cuIcon-title text-blue" />文字阴影
      </view>
    </view>
    <view class="grid col-5 padding-sm">
      <view v-for="(item,index) in ColorList" :key="index" class="padding-sm">
        <view class="text-center text-shadow" :class="'text-' + item.name">
          <view class="cuIcon-ellipse text-xxl" />
        </view>
      </view>
    </view>
    <view class="cu-bar bg-white solid-bottom margin-top">
      <view class="action">
        <text class="cuIcon-title text-blue" />文字截断
      </view>
    </view>
    ...
    <view class="cu-bar bg-white solid-bottom margin-top">
      <view class="action">
        <text class="cuIcon-title text-blue" />文字对齐
      </view>
    </view>
    <view class="padding bg-white">
    ...
    <view class="cu-bar bg-white solid-bottom margin-top">
      <view class="action">
        <text class="cuIcon-title text-blue" />特殊文字
      </view>
    </view>
