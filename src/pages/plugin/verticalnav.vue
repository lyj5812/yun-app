  ...
  <view>
    ...
    <view class="VerticalBox">
      ...
      <scroll-view
        ...
        @scroll="VerticalMain"
      >
        <view v-for="(item,index) in list" :id="'main-'+index" :key="index" class="padding-top padding-lr">
          <view class="cu-bar solid-bottom bg-white">
            <view class="action">
              <text class="cuIcon-title text-green" /> Tab-{{ item.name }}</view>
          </view>
          <view class="cu-list menu-avatar">
            ...
            <view class="cu-item cur">
              ...
              <view class="content">
                ...
                <view class="text-gray text-sm flex">
                  <text class="text-cut"> 伊泽瑞尔：<text class="cuIcon-locationfill text-orange margin-right-xs" /> 传送中...</text></view>
              </view>
              <view class="action">
                <view class="text-grey text-xs">22:20</view>
                <view class="cuIcon-notice_forbid_fill text-gray" />
