<template>
  <view>
    <cu-custom bg-color="bg-gradual-pink" :is-back="true"><block slot="backText">返回</block><block slot="content">卡片</block></cu-custom>
    <view class="cu-bar bg-white solid-bottom">
      <view class="action">
        <text class="cuIcon-titles text-orange" /> 案例类卡片
      </view>
      <view class="action">
        <switch :class="isCard?'checked':''" :checked="isCard?true:false" @change="IsCard" />
      </view>
    </view>
    ...
    <view class="cu-bar bg-white solid-bottom" :class="isCard?'margin-top':''">
      <view class="action">
        <text class="cuIcon-titles text-orange " /> 动态类卡片
      </view>
      <view class="action">
        <switch :class="isCard?'checked':''" :checked="isCard?true:false" @change="IsCard" />
      </view>
    ...
    <view class="cu-card dynamic" :class="isCard?'no-card':''">
      <view class="cu-item shadow">
        ...
        <view class="cu-list menu-avatar comment solids-top">
          ...
          <view class="cu-item">
            <view class="cu-avatar round" style="background-image:url(https://ossweb-img.qq.com/images/lol/web201310/skin/big10006.jpg);" />
            <view class="content">
              ...
              <view class="margin-top-sm flex justify-between">
                <view class="text-gray text-df">2018年12月4日</view>
                <view>
                  <text class="cuIcon-appreciate text-gray" />
                  <text class="cuIcon-messagefill text-gray margin-left-sm" />
                </view>
              </view>
            </view>
    ...
    <view class="cu-bar bg-white solid-bottom margin-top">
      <view class="action">
        <text class="cuIcon-titles text-orange " /> 文章类卡片
      </view>
      <view class="action">
        <switch :class="isCard?'checked':''" :checked="isCard?true:false" @change="IsCard" />
      </view>
