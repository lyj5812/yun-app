<template>
  <view>
    <cu-custom bg-color="bg-gradual-pink" :is-back="true"><block slot="backText">返回</block><block slot="content">操作条</block></cu-custom>
    ...
    <view class="box">
      <view class="cu-bar tabbar bg-white">
        <view class="action">
          <view class="cuIcon-cu-image">
            <image src="/static/tabbar/basics_cur.png" />
          </view>
        ...
        <view class="action">
          <view class="cuIcon-cu-image">
            <image src="/static/tabbar/plugin.png" />
        ...
        <view class="action">
          <view class="cuIcon-cu-image">
            <image src="/static/tabbar/about.png" />
      ...
      <view class="cu-bar bg-white tabbar border shop">
        ...
        <view class="action text-orange">
          <view class="cuIcon-favorfill" /> 已收藏
        </view>
        <view class="action">
          <view class="cuIcon-cart">
            <view class="cu-tag badge">99</view>
    ...
    <view v-if="false" class="box">
      <view class="cu-bar justify-center bg-white">
        <view class="action border-title">
          ...
          <text class="bg-grey" style="width:2rem" />
          <!-- 底部样式 last-child选择器-->
        </view>
      </view>
      <view class="cu-bar justify-center bg-white">
        <view class="action border-title">
          ...
          <text class="bg-gradual-blue" style="width:3rem" />
        </view>
      </view>
      <view class="cu-bar justify-center bg-white">
        <view class="action sub-title">
          <text class="text-xl text-bold text-green">关于我们</text>
          <text class="bg-green" style="width:2rem" />
          <!-- last-child选择器-->
        </view>
      </view>
      <view class="cu-bar justify-center bg-white">
    ...
    <view class="box">
      <view class="cu-bar bg-white">
        <view class="action">
          <text class="cuIcon-back text-gray" /> 返回
        </view>
      ...
      <view class="cu-bar bg-white">
        <view class="action">
          <text class="cuIcon-homefill text-gray" /> 首页
        </view>
        <view class="content text-bold">
          鲜亮的高饱和色彩，专注视觉的小程序组件库
        </view>
        <view class="action">
          <text class="cuIcon-cardboardfill text-grey" />
          <text class="cuIcon-recordfill text-red" />
        </view>
      </view>
      <view class="cu-bar bg-blue">
        <view class="action">
          <text class="cuIcon-close" /> 关闭
        </view>
        <view class="content text-bold">
          海蓝
        </view>
    ...
    <view class="box">
      <view class="cu-bar search bg-white">
        <view class="search-form round">
          ...
          <input :adjust-position="false" type="text" placeholder="搜索图片、文章、视频" confirm-type="search" @focus="InputFocus" @blur="InputBlur"/>
        </view>
        <view class="action">
      ...
      <view class="cu-bar bg-red search">
        <view class="cu-avatar round" style="background-image:url(https://ossweb-img.qq.com/images/lol/web201310/skin/big114004.jpg);" />
    ...
    <view class="box">
      <view class="cu-bar input">
        ...
        <input :adjust-position="false" class="solid-bottom" :focus="false" maxlength="300" cursor-spacing="10" @focus="InputFocus" @blur="InputBlur"/>
        <view class="action">
      ...
      <view class="cu-bar input">
        <view class="cu-avatar round" style="background-image:url(https://ossweb-img.qq.com/images/lol/web201310/skin/big91012.jpg);" />
        <view class="action">
          <text class="cuIcon-roundaddfill text-grey" />
        </view>
        <input :adjust-position="false" class="solid-bottom" maxlength="300" cursor-spacing="10" @focus="InputFocus" @blur="InputBlur"/>
        <view class="action">
          <text class="cuIcon-emojifill text-grey" />
        </view>
        <button class="cu-btn bg-green shadow-blur">发送</button>
