<template>
  <view>
    <cu-custom bg-color="bg-gradual-pink" :is-back="true"><block slot="backText">返回</block><block slot="content">时间轴</block></cu-custom>
          ...
          <view class="cu-list menu-avatar radius">
            <view class="cu-item">
              ...
              <view class="content">
                ...
                <view class="text-gray text-sm">
                  <text class="cuIcon-infofill text-red" /> 消息未送达</view>
              </view>
              <view class="action">
            ...
            <view class="cu-item">
              ...
              <view class="content">
                ...
                <view class="text-gray text-sm">
                  <text class="cuIcon-redpacket_fill text-red" /> 收到红包</view>
              </view>
              <view class="action">
                <view class="text-grey text-xs">22:20</view>
                <text class="cuIcon-notice_forbid_fill text-gray" />
              </view>
            </view>
          </view>
        </view>
